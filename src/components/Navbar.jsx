...
import { Sparkles, Eye, Mic, ShieldCheck, CheckCircle2, ChevronRight, Volume2 } from 'lucide-react'
    ...
    <header className={`sticky top-0 z-50 border-b transition-colors duration-200 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          {/* Header Logo & Track 5 Badge */}
          <div className="flex items-center space-x-3.5">
            <div className={`w-12 h-12 rounded-2xl flex items-center justify-center font-bold text-xl shadow-md transition-transform hover:scale-105 ${
              highContrast 
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-xl sm:text-2xl font-black tracking-tight font-heading">
                  AdaptiveStyle <span className={highContrast ? 'text-yellow-400 underline decoration-yellow-400' : 'text-sky-600'}>AI</span>
                </span>
          ...
          <div className="flex items-center gap-2 sm:gap-3" role="toolbar" aria-label="Accessibility controls">
            ...
            <button
              ...
              id="speech-assistant-btn"
              aria-pressed={isListening}
              aria-label={isListening ? "Speech Assistant Listening. Click to pause." : "Enable Speech Assistant voice control"}
              ...
              title="Voice Commands: 'Next step', 'Previous step', 'Scan garment', 'Read accessibility score out loud', 'Select magnetic shirt'"
            >
              {isListening && (
              ...
              <span className="hidden md:inline text-xs font-bold">
                {isListening ? 'Listening (Hands-Free)...' : 'Speech Assistant'}
              </span>
            ...
            <div className={`flex items-center rounded-xl p-1 border min-h-[48px] ${
              ...
              <button
                ...
                title="Extra large font size (+40%)"
              >
                A++
              </button>
            </div>

            {/* High-Contrast Mode Toggle (Dark HC vs Light HC) */}
            <button
              ...
              title="Toggle High Contrast Mode (WCAG AAA compliant contrast)"
            >
      ...
      {/* Step Stepper Progress Bar: [1. Profile -> 2. AI Scanner -> 3. Matched Catalog -> 4. Customization & Dispatch] */}
